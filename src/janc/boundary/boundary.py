...
def boundary_conditions(U, theta=None):
    U_periodic_pad= pad(U)
    U_with_lb = boundary_func['left_boundary'](U_periodic_pad,theta)
    U_with_rb = boundary_func['right_boundary'](U_with_lb,theta)
